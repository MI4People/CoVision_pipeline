...
# Custom packages
from pipeline_segmentation.transformations_segmentation import resize_image
from utils_segmentation.utils_dataset import compute_bounding_box_coordinates


def extract_corrected_membrane(data_args, inference_args, image, model, return_mask=False):
    """
