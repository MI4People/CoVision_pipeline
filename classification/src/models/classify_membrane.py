...
from src.data.transformations import PreprocessMembraneZones

def classify_membrane(args, membrane_path, model, show_bool=False):
    """
    ...
    # Read membrane image
    membrane = cv2.imread(membrane_path)
    # Crop relevant zones
